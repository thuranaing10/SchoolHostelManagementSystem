...
@section('content')
    <section class="content-header">
        ...
        <span class="breadcrumb"><a href='{{ route("frollcall.index") }}' class="btn btn-sm btn-primary"><i
    ...
    <div class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                {!! Form::model($roll, ['route' => ['frollcall.update', $roll->id], 'method' => 'patch']) !!}
                    ...
                    <div class="form-group col-sm-12">
                       ...
                       <a href="{!! route('frollcall.index') !!}" class="btn btn-default">Cancel</a>
                    </div>
