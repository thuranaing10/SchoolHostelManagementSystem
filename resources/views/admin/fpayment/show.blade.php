...
@section('content')
    <section class="content-header">
        ...
        <span class="breadcrumb"><a href='{{ route("fpayment.index") }}' class="btn btn-sm btn-primary"><i class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;Go To Payment</a></span>
    </section>
    <div class="content">
        {{-- <div class="row">
            <form method="GET">
                    ...
                    @foreach(getPayment($rolls->id) as $record)
                        <tr>
                            ...
                            <td><a href="#" type="button" data-id="{{ $record->id }}"
                               ...
                               data-url="{{ url('admin/fpayment/'.$record->id) }}"
